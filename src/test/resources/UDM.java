...
//
package udm.core.parser;

import java.io.ByteArrayOutputStream;
import java.util.ArrayList;
import udm.*;
import udm.core.expressions.*;
...
public class Parser {
    ...
    public boolean Parse_ROOT_VALUE(String input, final Ref<UdmValue> output, final Ref_int pos) {
        _input     = input.toCharArray();
        pos.val    = 0;
        output.val = null;
    ...
    private boolean nt_ROOT_VALUE(final Ref_int pos, final Ref<UdmValue> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref<Object> output1 = new Ref<Object>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_VALUE(final Ref_int pos, final Ref<Expression> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref<UdmBinary> output1 = new Ref<UdmBinary>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
        ...
        {
            final Ref<UdmNumber> output1 = new Ref<UdmNumber>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
        ...
        {
            final Ref<UdmText> output1 = new Ref<UdmText>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_NUMBER(final Ref_int pos, final Ref<UdmNumber> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref<Object> output1 = new Ref<Object>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_IDENT(final Ref_int pos, final Ref<UdmText> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref<Object> output1 = new Ref<Object>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_STRING(final Ref_int pos, final Ref<UdmText> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref_int pos1 = new Ref_int(pos0.val);
            if(tc(pos1, '\"')) {
    ...
    private boolean nt_BINARY(final Ref_int pos, final Ref<UdmBinary> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref_int pos1 = new Ref_int(pos0.val);
            if(ts(pos1, t_17 /* "0x" */)) {
            ...
            if(ts(pos1, t_20 /* "[ / " */)) {
                ...
                if(nt_WS(pos2, output2)) {
                    ...
                    if(nt_REFERENCE_HEAD(pos3, output3)) {
                        final Ref_int pos4 = new Ref_int(pos3.val);
                        if(tc(pos4, ']')) {
                            output.val=new Reference(output3.val).propagateConst(session);
                            pos.val = pos4.val;
                            return true;
                        }
                    }
    ...
    private boolean nt_COMPLEX(final Ref_int pos, final Ref<Expression> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            ...
            if(tc(pos1, '[')) {
                ...
                final Ref_int pos2 = new Ref_int(pos1.val);
                if(nt_WSML(pos2, output2)) {
                    final Ref<ArrayList<Pair>> output3 = new Ref<ArrayList<Pair>>(null);
                    final Ref_int pos3 = new Ref_int(pos2.val);
                    if(nt_COMPLEX_HEAD(pos3, output3)) {
                        final Ref_int pos4 = new Ref_int(pos3.val);
                        if(tc(pos4, ']')) {
                            output.val=new Complex(output3.val).propagateConst(session);
                            pos.val = pos4.val;
                            return true;
                        }
                    }
    ...
    private boolean nt_COMPLEX_HEAD(final Ref_int pos, final Ref<ArrayList<Pair>> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_COMPLEX_CHILD(final Ref_int pos, final Ref<ArrayList<Pair>> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref<Expression> output1 = new Ref<Expression>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
                    ...
                    if(tc(pos3, ':')) {
                        ...
                        if(nt_WS(pos4, output4)) {
                            ...
                            if(nt_EXPRESSION(pos5, output5)) {
                                appendT(output, new Pair(output1.val, output5.val));
                                pos.val = pos5.val;
                                return true;
                            }
                        }
        ...
        }
        {
            ...
            if(nt_EXPRESSION(pos1, output1)) {
                appendT(output, new Pair(output1.val, null));
                pos.val = pos1.val;
                return true;
            }
        }
    ...
    private boolean nt_COMPLEX_TAIL(final Ref_int pos, final Ref<ArrayList<Pair>> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref<Object> output1 = new Ref<Object>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_TAG(final Ref_int pos, final Ref<Expression> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref_int pos1 = new Ref_int(pos0.val);
            if(tc(pos1, '@')) {
                ...
                if(nt_WS(pos2, output2)) {
                    ...
                    if(nt_KEY(pos3, output3)) {
                        ...
                        if(nt_WS(pos4, output4)) {
                            ...
                            final Ref_int pos5 = new Ref_int(pos4.val);
                            if(nt_EXPRESSION(pos5, output5)) {
                                output.val=new Tag(output3.val, output5.val).propagateConst(session);
                                pos.val = pos5.val;
                                return true;
                            }
                        }
            ...
            if(ts(pos1, t_21 /* "::" */)) {
                ...
                if(nt_WS(pos2, output2)) {
                    ...
                    if(nt_EXPRESSION(pos3, output3)) {
                        output.val = new UnaryOperator(UnaryOperator.Operator.TypeLiteral, output3.val).propagateConst(session);
                        pos.val = pos3.val;
                        return true;
                    }
                }
        ...
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            ...
            if(ts(pos1, t_22 /* "->" */)) {
                ...
                if(nt_WS(pos2, output2)) {
                    ...
                    final Ref_int pos3 = new Ref_int(pos2.val);
                    if(nt_EXPRESSION(pos3, output3)) {
                        output.val = new UnaryOperator(UnaryOperator.Operator.FunctionLiteral, output3.val).propagateConst(session);
                        pos.val = pos3.val;
                        return true;
                    }
                }
    ...
    private boolean nt_EXPR_OPCALL(final Ref_int pos, final Ref<Expression> output) {
        ...
        }
        {
            ...
            if(tc(pos1, '.')) {
                ...
                final Ref_int pos2 = new Ref_int(pos1.val);
                if(nt_WS(pos2, output2)) {
                    final Ref<UdmText> output3 = new Ref<UdmText>(null);
                    final Ref_int pos3 = new Ref_int(pos2.val);
    ...
    private boolean nt_EXPR_LEAF(final Ref_int pos, final Ref<Expression> output) {
        ...
        {
            final Ref<Function> output1 = new Ref<Function>(null);
            final Ref_int pos1 = new Ref_int(pos0.val);
    ...
    private boolean nt_EXPR_FUNC(final Ref_int pos, final Ref<Function> output) {
        final Ref_int pos0 = new Ref_int(pos.val);
        {
            final Ref_int pos1 = new Ref_int(pos0.val);
            if(tc(pos1, '(')) {
                                ...
                                if(ts(pos6, t_77 /* "->" */)) {
                                    ...
                                    if(nt_WS(pos7, output7)) {
                                        ...
                                        if(nt_EXPRESSION(pos8, output8)) {
                                            output.val = new Function(false, output3.val, output8.val);
                                            pos.val = pos8.val;
                                            return true;
                                        }
                                    }
